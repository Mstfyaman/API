...
public class POJO_DeSerialization {  // PetStoryUser classındaki bilgileri kullanıyoruz.
    ...
    public void oneUserPetStore(){
        ...
        PetStoryUser oneUser = response.body().as(PetStoryUser.class);
        ...
        Assert.assertEquals(oneUser.getUserStatus(),21.0);
